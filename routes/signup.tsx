...
export default function Signup(props: PageProps) {
    ...
    return ( <section class="bg-black-700">
      ...
      <div class="w-full bg-black - 700 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" method="POST">
            ...
            <button type="submit" class="w-full text-white bg-blue-300 border- hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign Up</button>
